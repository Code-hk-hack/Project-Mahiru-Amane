# Graph Report - E:\hacakhthon  (2026-07-17)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 8775 nodes · 15859 edges · 651 communities (533 shown, 118 thin omitted)
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 2948 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2198dbec`
...
- test_rebuild_code_prunes_final_deleted_file
...
- shapes
- Transformer
- test_anthropic_custom_endpoint.py
- test_label_retry.py
- _make_cli_envelope
- test_pascal_no_duplicate_method_edges_tree_sitter
...
- test_worktree_guard_runs_on_primary_skips_linked
...
- test_rebuild_bodies_read_graphify_root
- test_rebuild_bodies_with_graphify_root_are_valid_python
- test_probes_use_find_spec_not_full_import
- test_shebang_read_is_null_byte_safe
- test_probe_prefers_sibling_python_exe_on_windows_layouts
- test_hooks_reuse_git_dir_from_env
- test_hooks_honor_skip_env
- test_hooks_skip_linked_worktrees
- test_call_claude_cli_tolerates_non_utf8_in_stderr
- test_resolve_max_retries_default_and_env
- test_openai_compat_client_built_with_retries
- test_call_llm_claude_client_built_with_timeout_and_retries
- test_call_llm_openai_compat_client_built_with_timeout_and_retries
- test_native_extraction_prompt_requests_hyperedges
- test_native_extraction_prompt_matches_skill_spec_on_hyperedges
- test_ingest_symbol_trailing_hash_no_display_name_has_non_empty_label
- test_relationship_edges_survive_validate_extraction_and_build
- test_non_string_symbol_id_is_skipped
- test_relationship_symbol_non_string_is_skipped
- test_non_string_display_name_falls_back
- test_documents_field_non_list_returns_empty
- test_document_entry_non_dict_is_skipped
- test_occurrence_negative_line_falls_back_to_zero
- test_duplicate_local_symbol_resolves_to_same_document
- test_ingest_symbol_without_occurrences_has_empty_source_location
- test_ingest_node_metadata_control_chars_stripped
- test_ingest_edge_source_location_from_first_occurrence
- test_ingest_single_symbol_no_relationships
- test_ingest_node_id_differs_by_source_file
...
- test_ingest_symbol_item_not_a_dict_is_skipped
- test_ingest_symbol_without_symbol_id_is_skipped
- test_ingest_document_with_symbols_not_a_list
- test_ingest_default_source_file_is_empty_string
- test_ingest_document_without_language_defaults_to_function_param
- test_ingest_symbol_with_non_dict_occurrence_is_skipped
- test_ingest_symbol_with_non_list_range_falls_back_to_zero
- test_ingest_symbol_without_display_name_uses_suffix
- test_ingest_symbol_with_empty_documentation_skips_description
- test_headings_helper_ignores_code_fence_comments
- test_audit_coverage_passes_for_codex_and_windows
- test_audit_coverage_passes
- test_descriptions_are_unified
- test_windows_frontmatter_name_and_shell_and_extra
- test_schema_singleton_catches_legacy_enums
- test_all_progressive_hosts_check_and_audit_clean
- test_render_is_idempotent
- test_monoliths_render_inline_single_file_no_references
- test_monolith_roundtrip_passes_for_aider_and_devin
- test_monoliths_change_only_sanctioned_lines
- test_monoliths_carry_the_1392_runbook_fixes
- test_always_on_renders_six_blocks
- test_always_on_included_in_full_render_not_per_platform
- test_always_on_roundtrip_is_byte_faithful
- test_extracted_constants_equal_the_packaged_always_on_files
- test_audit_coverage_passes_for_every_split_host
- test_audit_reads_each_host_against_its_own_v8_body
- test_audit_catches_an_induced_per_host_drop
- test_audit_catches_a_dropped_non_allowlisted_heading
- test_claude_flavored_hosts_keep_their_hooks_text_unchanged
- test_amp_has_no_pretooluse_caveat_anywhere
- test_amp_audit_coverage_passes_against_its_own_v8
- test_agents_body_matches_amp_modulo_hooks_wording
- test_agents_audit_baseline_is_amps_v8_body
- test_semantic_cache_calls_pass_prompt_file_for_every_split_host
- test_rebuild_code_normalizes_preserved_source_paths
- test_rebuild_code_prunes_renamed_ast_backed_document
- __main__.py
- TButton
- x
- y
...
1. `extract()` - 233 edges
2. `_read_text()` - 82 edges
3. `ingest_scip_json()` - 82 edges
4. `_rebuild_code()` - 78 edges
5. `detect()` - 74 edges
6. `_labels()` - 74 edges
7. `extract_js()` - 64 edges
8. `_file_stem()` - 61 edges
9. `dispatch_command()` - 57 edges
10. `_edge_labels()` - 56 edges

## Surprising Connections (you probably didn't know these)
- `_build_http_app()` --indirect_call--> `lifespan()`  [INFERRED]
  graphify/graphify/serve.py → backend/main.py
- `get_db()` --references--> `Client`  [EXTRACTED]
  backend/database.py → graphify/worked/httpx/raw/client.py
- `health_check()` --indirect_call--> `e()`  [INFERRED]
  backend/main.py → graphify/scripts/gen_demo_path.py
- `chat_endpoint()` --indirect_call--> `e()`  [INFERRED]
  backend/main.py → graphify/scripts/gen_demo_path.py
- `websocket_voice_chat()` --indirect_call--> `e()`  [INFERRED]
  backend/main.py → graphify/scripts/gen_demo_path.py

## Import Cycles
- 1-file cycle: `graphify/tests/fixtures/sample.sv -> graphify/tests/fixtures/sample.sv`

## Communities (651 total, 118 thin omitted)

### Community 0 - "test_extract.py"
Cohesion: 0.02
Nodes (143): _is_noise_dir(), Return True if this directory name looks like a venv, cache, or dep dir., collect_files(), extract_bash(), Path, Bash extractor. Moved verbatim from graphify/extract.py., Extract functions, source imports, and cross-function calls from a .sh file., extract_json() (+135 more)

### Community 1 - "test_detect.py"
Cohesion: 0.03
Nodes (113): detect(), _is_sensitive(), Return True if this file likely contains secrets and should be skipped., Files matching .graphifyignore patterns are excluded from detect()., When no .graphifyignore exists, .gitignore patterns are honored (#945)., When both exist, their patterns are MERGED — a file excluded only by     .gitig, .graphifyignore is evaluated after .gitignore, so a `!` negation in it can, Files inside .worktrees/ are never indexed (#947). (+105 more)

### Community 2 - "_read_text"
Cohesion: 0.03
Nodes (107): _import_lua(), Extract require('module') from Lua variable_declaration nodes., _read_text(), _c_collect_type_refs(), _cpp_collect_type_refs(), _cpp_declarator_name(), _cpp_local_var_types(), _csharp_attribute_names() (+99 more)

### Community 3 - "test_install.py"
Cohesion: 0.03
Nodes (96): _agents_install(), _agents_uninstall(), _install(), _kilo_install(), _kilo_uninstall(), Tests for graphify install --platform routing., Project-scope amp install lands in .agents/skills, an Amp project search root., The user-scope `graphify uninstall` enumeration removes the amp skill. (+88 more)

### Community 4 - "install.py"
Cohesion: 0.05
Nodes (98): _agents_install(), _agents_platform_install(), _agents_platform_uninstall(), _agents_uninstall(), _always_on(), _amp_install(), _amp_legacy_cleanup(), _amp_uninstall() (+90 more)

### Community 5 - "classify_file"
Cohesion: 0.03
Nodes (87): classify_file(), Return the interpreter name from a shebang line.      Handles forms that a nai, _shebang_interpreter(), Plain shebang returns the interpreter basename., `#!/usr/bin/env python3` returns the interpreter, not 'env'., `#!/usr/bin/env -S python3 -u` (-S split-args form) recovers the interpreter., `#!/usr/bin/env -i bash` skips env flags and resolves to the interpreter., `#!/usr/bin/env DEBUG=1 python3` skips var=value assignments. (+79 more)

### Community 6 - "test_chunking.py"
Cohesion: 0.03
Nodes (81): BaseException, _chunk_partial_files(), extract_corpus_parallel(), _extract_with_adaptive_retry(), _looks_like_context_exceeded(), _mark_partial(), _merge_into(), _merged_partial_files() (+73 more)

### Community 7 - "test_analyze.py"
Cohesion: 0.04
Nodes (72): find_import_cycles(), _is_json_key_node(), Detect circular import dependencies at the file level.      Collapses symbol-l, _make_code_doc_graph(), _make_cross_lang_graph(), _make_cycle_graph_directed(), _make_file_node(), make_graph() (+64 more)

### Community 8 - "llm.py"
Cohesion: 0.04
Nodes (76): _backend_env_keys(), _backend_supports_vision(), _bedrock_inference_config(), _bind_node_evidence(), _build_image_refs(), _call_claude_cli(), _call_llm(), _claude_cli_envelope() (+68 more)

### Community 9 - "test_build.py"
Cohesion: 0.03
Nodes (71): dedupe_edges(), dedupe_nodes(), Collapse nodes sharing an ``id``, last-writer-wins on attributes.      Mirrors, Collapse exact parallel edges by ``(source, target, relation)``, keeping the, load_extraction(), Legacy nodes with file_type=None (e.g. preserved from older graph.json     by `, Nodes missing file_type entirely should also be canonicalized to 'concept'., Unknown file_type values are coerced through the synonym mapper, falling     ba (+63 more)

### Community 10 - "test_dotnet.py"
Cohesion: 0.05
Nodes (68): extract_csproj(), extract_slnx(), extract_xaml(), _project_xml_is_safe(), Reject XML that declares DTDs or entities.      Stdlib ``xml.etree.ElementTree, Extract projects and inter-project dependencies from a .slnx file.      .slnx, Extract packages, project refs, and target framework from a .csproj/.fsproj/.vbp, Extract WPF/XAML structure, bindings, x:Class, and event handler references. (+60 more)

### Community 11 - "test_import_extension_resolution.py"
Cohesion: 0.05
Nodes (71): Resolve a JS/TS module path or specifier to a local source file.      With a P, _resolve_js_module_path(), _import_targets(), Path, Tests for #716 — TypeScript bare-path imports, Svelte 5 rune file imports (`fro, JS variant of the rune file pattern: a `.svelte.js` file (used in     JavaScrip, When both `.svelte.ts` and `.svelte.js` exist (hybrid project mid-     migratio, If `foo.svelte` IS a real markup file, importing `./foo.svelte`     must resolv (+63 more)

### Community 12 - "test_languages.py"
Cohesion: 0.05
Nodes (66): extract_csharp(), extract_swift(), Extract C# type declarations, methods, namespaces, and usings from a .cs file., Extract classes, structs, protocols, functions, imports, and calls from a .swift, extract_fortran(), Extract programs, modules, subroutines, functions, use statements, and calls fro, _node_by_label(), _normalize_symbol_label() (+58 more)

### Community 13 - "test_codebuddy.py"
Cohesion: 0.05
Nodes (64): codebuddy_install(), codebuddy_uninstall(), Remove the graphify skill tree (SKILL.md + references/) and the graphify     se, Install the graphify skill and CODEBUDDY.md section for CodeBuddy., Remove graphify PreToolUse hook from .codebuddy/settings.json., _uninstall_codebuddy_hook(), _codebuddy_install_user(), _codebuddy_md_path() (+56 more)

### Community 14 - "to_wiki"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (55): _canonicalize_csharp_namespace_nodes(), _check_tree_sitter_version(), _extract_js_rationale(), extract_lua(), _extract_parallel(), _extract_python_rationale(), _extract_sequential(), _extract_single_file() (+47 more)

### Community 16 - "test_js_import_resolution.py"
Cohesion: 0.15
...
### Community 17 - "detect.py"
Cohesion: 0.06
Nodes (58): Enum, _auto_follow_symlinks(), convert_office_file(), _could_contain_included_path(), count_words(), docx_to_markdown(), _env_command_args(), extract_pdf_text() (+50 more)

### Community 18 - "resolution.py"
Cohesion: 0.06
Nodes (59): extract_svelte(), _import_c(), Extract imports from .svelte files: script-block via JS AST + template regex fal, _collect_python_symbol_resolution_facts(), _contained_in_package(), _decldef_class_stem(), _disambiguate_colliding_node_ids(), _find_workspace_root() (+51 more)

### Community 19 - "test_multilang.py"
Cohesion: 0.07
Nodes (58): extract_go(), Path, Extract functions, methods, type declarations, and imports from a .go file., extract_rust(), Path, Extract functions, structs, enums, traits, impl methods, and use declarations fr, Methods on the same receiver type must share one canonical type node., Type node id should be scoped to directory, not file stem. (+50 more)

### Community 20 - "deduplicate_entities"
Cohesion: 0.06
Nodes (56): deduplicate_entities(), Deduplicate near-identical entities in a knowledge graph.      Args:, _make_edges(), _make_nodes(), Tests for graphify/dedup.py entity deduplication pipeline., deduplicate_entities accepts dedup_llm_backend without crashing when no ambiguou, Chip SKU variants (ASR1603 vs ASR1605) must not be merged (#878)., Short labels differing by an insertion (cranel vs cranelr) must not merge (#878) (+48 more)

### Community 21 - "extract_js"
Cohesion: 0.04
Nodes (57): extract_js(), Extract classes, functions, arrow functions, and imports from a .js/.ts/.tsx/.mt, Functions defined alongside a JSX-returning component must be captured., Calls inside JSX expressions like `{fmtDate(now)}` must yield call edges., export { X } from './mod' must emit re_exports edges for each named specifier., Barrel file must emit file-level imports_from edges to source modules., re_exports edges should have context='re-export'., export function/const in a barrel file must still create nodes. (+49 more)

### Community 22 - "extract"
Cohesion: 0.13
Nodes (53): extract(), Extract AST nodes and edges from a list of code files.      Two-pass process:, _defs(), _node_by_id(), Path, _targets(), test_csharp_alias_matching_file_stem_resolves_via_token(), test_csharp_alias_using_scoped_to_its_block() (+45 more)

### Community 23 - "file_hash"
Cohesion: 0.07
Nodes (52): _absolutize_source_files_in(), cache_dir(), cached_files(), cached_word_count(), _cleanup_stale_ast_entries(), _ensure_stat_index(), file_hash(), _flush_stat_index() (+44 more)

### Community 24 - "_labels"
Cohesion: 0.04
Nodes (52): extract_cpp(), Extract functions, classes, and includes from a .cpp/.cc/.cxx/.hpp file., extract_apex(), Path, Apex extractor. Moved verbatim from graphify/extract.py., Extract classes, interfaces, enums, methods, and Salesforce constructs from, _labels(), Local const/let/var inside an arrow callback must NOT emit a node (#1077). (+44 more)

### Community 25 - "test_watch.py"
Cohesion: 0.04
Nodes (47): Tests for watch.py - file watcher helpers (no watchdog required)., End-to-end probe of the post-commit-delete bug fix.      Build a tiny graph, d, #1348: git-hook paths are repo-root-relative even when the graph root is a subdi, Pre-rebase subdirectory graphs stored source_file relative to watch_root., A rejected candidate keeps the marker paired with the existing graph., Changed files under followed symlinks retain their watched lexical path., #1059: the process that acquires the lock must drain .pending_changes     and p, #1059: after the primary rebuild, the lock-holder must loop and drain     any p (+39 more)

### Community 26 - "test_ruby_resolution.py"
Cohesion: 0.10
...
### Community 30 - "extract_python"
Cohesion: 0.07
Nodes (48): extract_python(), Extract classes, functions, and imports from a .py file via tree-sitter AST., All edge sources must reference a known node (targets may be external imports)., contains / method / inherits / imports edges must always be EXTRACTED., Call-graph pass must produce INFERRED calls edges., AST-resolved call edges are deterministic and should be EXTRACTED/1.0., run_analysis() calls compute_score() - must appear as a calls edge., Analyzer.process() calls run_analysis() - cross class→function calls edge. (+40 more)

### Community 31 - "test_cache.py"
Cohesion: 0.05
Nodes (45): _body_content(), Strip YAML frontmatter from Markdown content, returning only the body., Tests for graphify/cache.py., A .md file with no frontmatter is hashed by its full content., Non-.md files are still hashed by their full content., _body_content correctly strips YAML frontmatter., _body_content returns content unchanged when no frontmatter present., A document opening with a ``----`` thematic break has no frontmatter;     a lat (+37 more)

### Community 32 - "dependencies"
Cohesion: 0.04
Nodes (46): animejs, autoprefixer, clsx, eslint, eslint-config-next, framer-motion, dependencies, animejs (+38 more)

### Community 33 - "test_extract_cli.py"
Cohesion: 0.07
Nodes (46): _clear_backend_keys(), _code_only_corpus(), _make_corpus(), _node_sources(), Tests for `graphify extract` CLI dispatch path in graphify.__main__., Minimal corpus: one Go code file + one Markdown doc.      Both file types are, #1897: fresh extraction returns nodes with ROOT-RELATIVE source_file,     while, When every semantic chunk errors (e.g. backend SDK not installed),     the CLI (+38 more)

### Community 34 - "save_manifest"
Cohesion: 0.05
Nodes (46): detect_incremental(), load_manifest(), Load the manifest from a previous run. Returns {} on any error.      When ``ro, Save current file mtimes + content hashes for change detection.      kind="ast, Like detect(), but returns only new or modified files since the last run., save_manifest(), Files in failed chunks have no semantic cache entry; save_manifest must     lea, Code files must be stamped in the manifest regardless of semantic cache. (+38 more)

### Community 35 - "extract_objc"
Cohesion: 0.04
Nodes (45): extract_objc(), Path, objc — moved verbatim from graphify/extract.py., Extract interfaces, implementations, protocols, methods, and imports from .m/.mm, `@protocol Derived <Base>` must emit an implements edge Derived->Base.     Prot, `[self speak]` inside Dog.fetch must produce a calls edge. The method-body, `+ (…)shared` is a class method and must be labeled +shared, not -shared (#1475), A compound message `[self a:x b:y]` resolves to the compound method def (#1475). (+37 more)

### Community 36 - "_edge_labels"
Cohesion: 0.06
Nodes (45): extract_java(), extract_kotlin(), extract_scala(), Extract classes, interfaces, methods, constructors, and imports from a .java fil, Extract classes, objects, functions, and imports from a .kt/.kts file., _edge_labels(), `[[Foo alloc] init]` must emit a `references` edge to the project class Foo (#14, `class PooledClient : public Connection<HttpClient>` must emit the inherits (+37 more)

### Community 37 - "extract_powershell"
Cohesion: 0.05
Nodes (44): extract_powershell(), extract_powershell_manifest(), _psd1_collect_string_literals(), _psd1_module_name(), Path, Powershell extractor. Moved verbatim from graphify/extract.py., Extract functions, classes, methods, and using statements from a .ps1 file., Recursively collect all string_literal text values under *node*. (+36 more)

### Community 38 - "build.py"
Cohesion: 0.08
Nodes (40): build(), build_from_json(), build_merge(), _doc_twin_remap(), graph_has_legacy_ids(), _infer_merge_root(), _norm_source_file(), _old_file_stems() (+32 more)

### Community 39 - "test_export.py"
Cohesion: 0.09
Nodes (43): Export graph as GraphML - opens in Gephi, yEd, and any GraphML-compatible tool., to_graphml(), Generate an interactive vis.js HTML visualization of the graph.      Features:, to_html(), make_graph(), nx.write_graphml only accepts scalars; a dict/list attribute (per-node     meta, Coercion must leave GraphML-native scalars (int/float/bool/str) untouched,, #1838: neighbor links dropped an unescaped JSON.stringify(nid) into a     quote (+35 more)

### Community 40 - "test_semantic_cleanup.py"
Cohesion: 0.06
Nodes (42): Tests for graphify.semantic_cleanup.validate_semantic_fragment (#825)., Invalid JSON returns an error instead of raising., A node with file_type='rationale' is removed wholesale., Sentence-like rationale node connected via `rationale_for` → attribute on target, F3: a node with file_type='document' (allowed) that is BOTH sentence-like     A, A short named node with a period (e.g. abbreviation) is NOT sentence-like., F4: hyperedges referencing removed nodes are repaired or dropped., A hyperedge referencing only nodes not present in the fragment is dropped. (+34 more)

### Community 41 - "test_global_graph.py"
Cohesion: 0.10
Nodes (41): prefix_graph_for_global(), prune_repo_from_graph(), Return a copy of G with all node IDs prefixed with repo_tag::.      Labels are, Remove all nodes tagged with repo_tag from G in-place. Returns count removed., _file_hash(), global_add(), global_list(), global_path() (+33 more)

### Community 42 - "reflect.py"
Cohesion: 0.08
...
### Community 44 - "claude_install"
Cohesion: 0.08
Nodes (41): claude_install(), claude_uninstall(), Write the graphify section to the local CLAUDE.md., Strip the ## graphify section from one CLAUDE.md-style file.      Returns True, _strip_graphify_md_section(), Tests for graphify claude install / uninstall commands., claude_install also writes .claude/settings.json with PreToolUse hook., Running claude_install twice does not duplicate the PreToolUse hook. (+33 more)

### Community 45 - "test_mcp_ingest.py"
Cohesion: 0.11
...
### Community 46 - "test_serve.py"
Cohesion: 0.07
Nodes (41): _communities_from_graph(), _community_header(), _load_graph(), _query_terms(), Split a query into searchable terms, segmenting Chinese text, then drop     que, Reconstruct community dict from community property stored on nodes., Tests for serve.py - MCP graph query helpers (no mcp package required)., End-to-end for #1900: a German question over a graph with German     heading-no (+33 more)

### Community 47 - "FileSlice"
Cohesion: 0.10
Nodes (39): _best_cut(), bisect_slice(), expand_oversized_files(), FileSlice, is_splittable_text(), Path, Intra-file slicing for oversized text documents (#1369).  The extraction packe, Replace each oversized splittable-text file with a list of ``FileSlice``s. (+31 more)

### Community 48 - "test_indirect_dispatch.py"
Cohesion: 0.11
Nodes (40): _build(), _extract(), _extract_dir(), _extract_js_dir(), Indirect dispatch edges.  A function passed BY NAME as a call argument (`execu, No recall regression: a real module fn passed by name still emits an edge., Regression: when the scan root relativizes node ids (cache_root == project, Soundness carries across files: an imported name shadowed by a parameter     is (+32 more)

### Community 49 - "ingest_scip_json"
Cohesion: 0.05
...
### Community 50 - "serve.py"
Cohesion: 0.07
Nodes (35): _ApiKeyMiddleware, _build_http_app(), _build_server(), _compute_idf(), _filter_blank_stdin(), _filter_graph_by_context(), _has_chinese(), _infer_context_filters() (+27 more)

### Community 51 - "test_labeling.py"
Cohesion: 0.11
...
### Community 52 - "test_install_references.py"
Cohesion: 0.07
...
### Community 53 - "paths.py"
Cohesion: 0.08
Nodes (35): _atomic_replace(), disambiguate_ambiguous_candidates(), _is_test_path(), out_path(), _path_proximity_winner(), Path, Single source of truth for the graphify output-directory name.  The output dir, Classify a source path as a test path (case-insensitive, segment-aware). (+27 more)

### Community 54 - "test_transcribe.py"
Cohesion: 0.08
...
### Community 55 - "_rebuild_code"
Cohesion: 0.07
Nodes (37): _apply_resource_limits(), _canonical_graph_for_compare(), _canonical_topology_for_compare(), _changed_path_candidates(), _git_head(), _json_text(), _merge_changed_paths(), _node_community_map() (+29 more)

### Community 56 - "save_semantic_cache"
Cohesion: 0.09
Nodes (33): _group_has_partial_marker(), load_cached(), Return cached extraction for this file if hash matches, else None.      Cache, True if any node/edge/hyperedge in a per-file group carries the internal     ``, Save semantic extraction results to cache, keyed by source_file.      Groups n, save_semantic_cache(), merge_existing must not union a pre-fingerprint entry into a write it is     ab, Default save_semantic_cache replaces a file's cached entry (the final,     auth (+25 more)

### Community 57 - "_file_stem"
Cohesion: 0.07
Nodes (33): _import_js(), _file_stem(), _make_id(), Path, Stem used as the node-ID prefix for a file and its symbols.      The full path, _dynamic_import_js(), _js_extra_walk(), _js_member_assignment_target() (+25 more)

### Community 58 - "_make_graph"
Cohesion: 0.08
Nodes (36): _bfs(), Combined query scorer returning the existing ranked `(score, node_id)` list., Render subgraph as text, cutting at token_budget (approx 3 chars/token)., _score_nodes(), _subgraph_to_text(), _make_graph(), Coverage scaling must not touch full-coverage queries (coverage == 1).      A, An annotated node gets a `learning=<status>` suffix inside its NODE     bracket (+28 more)

### Community 59 - "test_scip_ingest.py"
Cohesion: 0.06
...
### Community 61 - "test_benchmark.py"
Cohesion: 0.13
...
### Community 62 - "exceptions.py"
Cohesion: 0.07
Nodes (31): CloseError, ConnectTimeout, CookieConflict, DecodingError, HTTPError, HTTPStatusError, PoolTimeout, ProtocolError (+23 more)

### Community 63 - "_collect_js_symbol_resolution_facts"
Cohesion: 0.08
Nodes (33): _augment_js_reexport_edges(), Compatibility wrapper for the JS/TS symbol-resolution post-pass., _NamespaceExportFact, models — moved verbatim from graphify/extract.py., _StarExportFact, _SymbolAliasFact, _SymbolDeclarationFact, _SymbolExportFact (+25 more)

### Community 64 - "test_claude_cli_backend.py"
Cohesion: 0.06
...
### Community 65 - "Response"
Cohesion: 0.12
Nodes (4): AsyncClient, Client, Synchronous HTTP client., Response

### Community 66 - "hooks.py"
Cohesion: 0.12
Nodes (32): _git_root(), _has_merge_attr(), _hooks_dir(), install(), _install_hook(), _merge_attr_line(), _merge_driver_status(), _pinned_python() (+24 more)

### Community 67 - "test_querylog.py"
Cohesion: 0.11
...
Cohesion: 0.10
Nodes (31): _make_git_repo(), Tests for hooks.py - git hook install/uninstall., Hook scripts must embed sys.executable so the hook works without the     graphi, End-to-end: the files written to .git/hooks must be nohup-free (#1161)., No core.hooksPath -> normal .git/hooks install, no rejection., install() must set merge.graphify.* via git config and add the     .gitattribut, Running install twice must not duplicate the .gitattributes line., A pre-existing .gitattributes entry must survive install (no clobber). (+23 more)

### Community 69 - "test_serve_http.py"
Cohesion: 0.13
Nodes (29): _call_tool(), _client(), _graph_file(), _init_session(), _project_with_graph(), Path, Tests for the Streamable HTTP transport on the MCP server (issue #1143).  Thes, A full initialize -> tools/list round trip works over the HTTP transport. (+21 more)

### Community 70 - "BaseTransport"
Cohesion: 0.11
...
### Community 71 - "e"
Cohesion: 0.11
Nodes (25): AnalystAgent, AnalystFeedback, CoachAgent, ensure_session_exists(), Any, BaseModel, Analyzes the user's message for passive language and boundary setting using Groq, Generates the Mahiru/Amane response incorporating the analyst feedback using an (+17 more)

### Community 72 - "HttpClient"
Cohesion: 0.10
Nodes (25): __global__, AuthedHttpClient, token_, Connection, resource, HttpClient, main(), string (+17 more)

### Community 73 - "_ImageRef"
Cohesion: 0.09
Nodes (30): _anthropic_content(), _azure_client(), _backend_pkg_hint(), _bedrock_content(), _call_azure(), _call_bedrock(), _call_claude(), _call_openai_compat() (+22 more)
...
### Community 76 - "export.py"
Cohesion: 0.08
Nodes (30): _cap_filename(), _cypher_escape(), _cypher_label(), existing_graph_node_count(), _git_head(), _obsidian_tag(), prune_dangling_edges(), Path (+22 more)

### Community 77 - "test_pascal.py"
Cohesion: 0.13
Nodes (20): extract_lazarus_form(), Path, Extract component hierarchy from Lazarus .lfm form files.      .lfm is a text-, _edges_with_relation(), Tests for the Pascal/Delphi extractor., _relations(), test_dfm_contains_edges_form_hierarchy(), test_lfm_contains_edges_form_hierarchy() (+12 more)

### Community 78 - "test_minhash.py"
Cohesion: 0.11
...
### Community 79 - "test_image_vision.py"
Cohesion: 0.10
...
### Community 80 - "test_hypergraph.py"
Cohesion: 0.09
Nodes (24): attach_hyperedges(), Store hyperedges in the graph's metadata dict., _alias_extraction(), _make_report(), Tests for hyperedge support in graphify., Write graph.json then reload it - hyperedges must survive., Three hyperedges, one per member-key spelling: nodes / members / node_ids., Alias normalization must run BEFORE the semantic id-remap loop so a     `member (+16 more)

### Community 81 - "_relations"
Cohesion: 0.08
Nodes (30): extract_php(), Extract classes, functions, methods, namespace uses, and calls from a .php file., Module-level arrow functions must still emit a node and capture their calls (#10, _relations(), test_apex_soql_uses_edge(), test_cpp_finds_includes(), test_java_finds_imports(), test_js_module_level_arrow_produces_node_and_call_edges() (+22 more)

### Community 82 - "TestSubprocessEncoding"
Cohesion: 0.07
...
### Community 83 - "gen.py"
Cohesion: 0.07
Nodes (29): _enum_lines(), _is_cache_unlink_fix_line(), _is_chunk_cleanup_line(), _is_content_scope_fix_line(), _is_directed_fix_line(), _is_enum_line(), _is_frontmatter_description_line(), _is_manifest_root_fix_line() (+21 more)

### Community 84 - "write_callflow_html"
Cohesion: 0.09
...
### Community 85 - "dispatch_command"
Cohesion: 0.11
Nodes (25): _clone_repo(), _default_graph_path(), dispatch_command(), _enforce_graph_size_cap_or_exit(), _prune_graph_json_sources(), Path, graphify command dispatch — every non-install subcommand.  Extracted verbatim, Source files graph.json still references but the current scan no longer     con (+17 more)

### Community 86 - "_platform_artifacts"
Cohesion: 0.07
...
### Community 87 - "api.py"
Cohesion: 0.09
Nodes (26): handle_delete(), handle_get(), handle_list(), handle_search(), handle_upload(), API module - exposes the document pipeline over HTTP. Thin layer over parser, v, Accept a list of file paths, run the full pipeline on each,     and return a su, Fetch a document by ID and return it. (+18 more)

### Community 88 - "analyze.py"
Cohesion: 0.12
...
### Community 90 - "test_install_roundtrip.py"
Cohesion: 0.09
...
### Community 91 - "test_read_hook.py"
Cohesion: 0.12
...
### Community 93 - "sample.swift"
Cohesion: 0.09
Nodes (17): Bool, Foundation, CacheManager, createProcessor(), NetworkError, connectionFailed, failed, timeout (+9 more)

### Community 94 - "test_multigraph_diagnostics.py"
Cohesion: 0.18
Nodes (25): diagnose_file(), Diagnose a graph/extraction JSON file without mutating it.      When `directed, _diagnostic_fixture(), Path, test_diagnose_extraction_accepts_node_link_links_key(), test_diagnose_extraction_bounds_examples(), test_diagnose_extraction_categorizes_same_endpoint_collapse(), test_diagnose_extraction_defaults_raw_inputs_to_directed() (+17 more)

### Community 95 - "to_obsidian"
Cohesion: 0.12
Nodes (26): Export graph as an Obsidian vault - one .md file per node with [[wikilinks]],, to_obsidian(), _four_node_two_community_graph(), #1506: exporting into an existing vault must not overwrite a user's note that, No regression: a fresh/empty dir still gets every note + .obsidian/graph.json., A re-run overwrites graphify's own prior notes (via the manifest) but leaves a, #1896: re-exporting into the same vault must delete graphify's own notes for, #1896 follow-on: a node that disappears and later returns must be writable (+18 more)

### Community 96 - "_edges_with_relation"
Cohesion: 0.08
Nodes (26): extract_c(), Extract functions and includes from a .c/.h file., extract_elixir(), Path, Elixir extractor. Moved verbatim from graphify/extract.py., Extract modules, functions, imports, and calls from a .ex/.exs file., _edges_with_relation(), `alias Foo.{Bar, Baz}` must emit one imports edge per expanded module.      Th (+18 more)

### Community 97 - "extract_vue"
Cohesion: 0.15
Nodes (24): extract_vue(), Extract imports, symbols, and type refs from a ``.vue`` SFC.      Masks the no, _parse_js_tree(), Blank everything outside ``<script>`` bodies, keeping ``\\r``/``\\n``.      Re, _vue_mask_non_script(), Path, Tests for ``.vue`` SFC extraction.  Feeding a whole SFC to the JS grammar prod, Vue allows a classic ``<script>`` plus ``<script setup>``; both are TS. (+16 more)

### Community 98 - "_find_node"
Cohesion: 0.10
Nodes (27): _find_node(), _get_trigram_index(), _node_search_text(), Character trigrams of `text`; for <3-char text the whole string is the key., Concatenate every field _score_nodes / _find_node match a query against, so, Lazily build and cache a trigram -> node-position postings map on the graph., Node IDs whose text could contain any `needle` as a substring, via the     trig, Return node IDs whose label or ID matches the search term (diacritic-insensitive (+19 more)

### Community 99 - "test_agents_platform.py"
Cohesion: 0.10
...
### Community 100 - "test_hook_guard.py"
Cohesion: 0.14
...
### Community 101 - "test_llm_backends.py"
Cohesion: 0.08
...
### Community 102 - "test_merge_chunks_validation.py"
Cohesion: 0.13
Nodes (24): _normalize_hyperedge_members(), Canonicalize a hyperedge's member list onto the `nodes` key, in place.      If, _append_rationale_attr(), _is_sentence_like_rationale_label(), load_validated_semantic_fragment(), Path, Load and validate a semantic chunk, rejecting oversize files before parsing., Clean up a semantic extraction fragment in-place.      Operations:     1. Rem (+16 more)

### Community 103 - "check_semantic_cache"
Cohesion: 0.08
Nodes (26): check_semantic_cache(), Check semantic extraction cache for a list of absolute file paths.      Return, Entries written before fingerprinting have unknowable vintage. They are     sti, Once a file is re-extracted under the current prompt, its fingerprinted     ent, A skill snippet substitutes SPEC_PATH by hand. If it lands on a path that     i, The prompt-file fingerprint is memoized per (path, size, mtime); an edited, mode='deep' saves under cache/semantic-deep/ and reads back from it., Deep entries must not satisfy mode=None reads (and plain entries must     not s (+18 more)

### Community 104 - "introspect_cargo"
Cohesion: 0.14
...
### Community 105 - "_load_graphifyignore"
Cohesion: 0.10
Nodes (26): _is_ignored(), _load_graphifyignore(), Read .graphifyignore files and return (anchor_dir, pattern) pairs.      Patter, Return True if the path should be ignored per .graphifyignore patterns.      U, info/exclude is loaded at lowest priority, so a later .gitignore `!` negation, A ! re-include cannot un-ignore a file whose parent dir is excluded (#882)., A ! re-include must still un-ignore a file when no ancestor is excluded (#882)., If the ancestor dir itself is re-included, its children should not be blocked (# (+18 more)

### Community 106 - "_extract_generic"
Cohesion: 0.08
Nodes (26): Get the name from a node using config.name_field, falling back to child types., _resolve_name(), _csharp_member_type_table(), _csharp_pre_scan_interfaces(), _extract_generic(), _find_body(), _js_module_bound_names(), Path (+18 more)

### Community 107 - "extract_dmm"
Cohesion: 0.09
...
### Community 108 - "extract_markdown"
Cohesion: 0.08
...
### Community 109 - "introspect_postgres"
Cohesion: 0.14
Nodes (24): introspect_postgres(), _quote_ident(), Connect to PostgreSQL, reconstruct DDL, and extract via extract_sql()., Double-quote a PostgreSQL identifier, escaping embedded double-quotes., _make_mock_psycopg(), _q(), Baseline: tables, views, routines, and a single-column FK all survive., Reserved-word and special-character table names must survive DDL round-trip. (+16 more)

### Community 110 - "resolve_bash_source_edges"
Cohesion: 0.09
...
### Community 112 - "test_skillgen.py"
Cohesion: 0.08
Nodes (25): Tests for the tools/skillgen generator and the claude lean-core split.  skillg, Regression for #1461: every skill body that describes Step 3 extraction must, The committed codex/windows artifacts match a fresh render and expected/., The committed artifacts and the expected/ snapshot match a fresh render., The file_type enum is the six-value superset in every rendered artifact., Generated artifacts use LF newlines and end in exactly one newline., #1757: generated monoliths pass the dispatched-file allowlist when     replacin, #1417: every save_manifest call in a shipped runbook threads root=.      Witho (+17 more)

### Community 113 - "BaseClient"
Cohesion: 0.11
Nodes (16): Auth, BasicAuth, BearerAuth, NetRCAuth, Authentication handlers. Auth objects are callables that modify a request befor, Load credentials from ~/.netrc based on the request host., Base class for all authentication handlers., HTTP Basic Authentication. (+8 more)

### Community 114 - "google_workspace.py"
Cohesion: 0.12
...
### Community 116 - "generate_section_flowchart"
Cohesion: 0.11
...
### Community 117 - "_make_id"
Cohesion: 0.12
Nodes (23): _extract_spock_fallback(), _import_java(), _import_kotlin(), _import_php(), _import_python(), _import_scala(), _import_swift(), Regex-based fallback for Spock spec files where tree-sitter-groovy cannot parse (+15 more)

### Community 118 - "__main__.py"
Cohesion: 0.11
Nodes (19): _check_skill_version(), __getattr__(), main(), Path, graphify CLI - `graphify install` sets up the Claude Code skill., Warn if the installed skill is from an older graphify version., Parse a version string into a comparable integer tuple (``0.9.2`` -> ``(0, 9, 2), Handle a downstream reader that closed the pipe early. Redirect stdout to     d (+11 more)

### Community 119 - "generate"
Cohesion: 0.19
Nodes (22): generate(), _learning_section(), Append the ``## Work-memory lessons`` section, or nothing when empty., Mirrors export.safe_name so community hub filenames and report wikilinks always, _safe_community_name(), make_inputs(), When a work-memory overlay (preferred sources) and query-scoped dead-ends     a, No learning input => no section; report identical to pre-feature. (+14 more)

### Community 120 - "Request"
Cohesion: 0.12
Nodes (8): DigestAuth, Modify the request. May yield to inspect the response., HTTP Digest Authentication.     Requires a full request/response cycle: sends t, Extract digest parameters from the WWW-Authenticate header., Compute the Authorization header value for a digest challenge., Request, ConnectionPool, Manages a pool of persistent HTTP connections.     Keys connections by (scheme,

### Community 121 - "diagnose_extraction"
Cohesion: 0.17
Nodes (22): _canonical_edge(), _count_extra(), diagnose_extraction(), _edge_list(), _exact_signature(), format_diagnostic_json(), format_diagnostic_report(), _node_ids() (+14 more)

### Community 122 - "multigraph_compat.py"
Cohesion: 0.18
...
### Community 123 - "prs.py"
Cohesion: 0.30
Nodes (22): bold(), _c(), _ci_icon(), cmd_prs(), cyan(), dim(), green(), magenta() (+14 more)

### Community 124 - "security.py"
Cohesion: 0.13
Nodes (17): _build_opener(), _ip_is_blocked(), _NoFileRedirectHandler, Resolve *host* once and return (family, validated_ip) for the first     address, HTTPConnection that resolves + validates DNS once, then connects to the     exa, HTTPSConnection variant of _SSRFGuardedHTTPConnection.      Connects to the va, urllib handler that routes http:// through _SSRFGuardedHTTPConnection., Redirect handler that re-validates every redirect target.      Prevents open-r (+9 more)

### Community 125 - "_pick_seeds"
Cohesion: 0.10
Nodes (23): _pick_seeds(), Select BFS seed nodes, stopping when score drops too far below the top.      P, DiGraph, FooBarService at 1000 vs error nodes at 1.0 → only 1 seed chosen., When all scores are within 20% of the top, keep up to 3 seeds., Never return more than max_k seeds even when all scores are close., G/best_seed_by_term are optional and default to None: existing callers     see, Reproduces #1445: a vague natural-language query where one term's     incidenta (+15 more)

### Community 126 - "symbol_resolution.py"
Cohesion: 0.13
...
### Community 127 - "Cookies"
Cohesion: 0.11
Nodes (4): Cookies, Headers, Core data models: URL, Headers, Cookies, Request, Response. These are the centr, URL

### Community 128 - "_get_extractor"
Cohesion: 0.10
Nodes (22): _get_extractor(), _is_cpp_header(), Any, Whether a `.h` file is C++ rather than plain C (#1547).      Mirrors `_is_objc, Return the correct extractor function for a file, or None if unsupported., test_dispatch_table(), Extensionless CLIs resolve their extractor from the shebang, mirroring     dete, test_extensionless_shebang_via_dispatch() (+14 more)

### Community 129 - "_key"
Cohesion: 0.12
Nodes (21): Resolve cross-file Swift member calls (``recv.method()``) to the real     defin, Resolve cross-file Python qualified class-method calls (``ClassName.method()``), Resolve cross-file TS/JS member calls via constructor-injection type tables (#13, Resolve cross-file C++ member calls (``f.bar()``, ``f->bar()``,     ``Foo::bar(, Resolve C# member calls (``recv.Method()``) to the receiver's declared type, Resolve Java member calls against the receiver's declared type.      Explicit, Resolve cross-file Objective-C message sends (``[recv sel]``) to the real     d, _resolve_cpp_member_calls() (+13 more)

### Community 130 - "test_security.py"
Cohesion: 0.15
Nodes (20): check_graph_file_size_cap(), _max_graph_file_bytes(), Reject *path* if its size exceeds the configured graph-file cap.      Protects, Return the graph.json size cap in bytes.      Honors the ``GRAPHIFY_MAX_GRAPH_, Tests for graphify/security.py - URL validation, safe fetch, path guards, label, test_graph_size_cap_at_boundary_passes(), test_graph_size_cap_error_message_includes_size_and_cap(), test_graph_size_cap_missing_file_silently_returns() (+12 more)

### Community 131 - "_search_tokens"
Cohesion: 0.16
Nodes (21): _pick_scored_endpoint(), Pick a path endpoint from a _score_nodes result, preferring full-token matches., Split text into word tokens, stripping punctuation and diacritics., _search_tokens(), _bench(), _build_random_graph(), _legacy_score_and_pick(), _legacy_traversal_count() (+13 more)

### Community 132 - "_check_shrink"
Cohesion: 0.12
Nodes (22): _check_shrink(), Return True (ok to proceed) or False (shrink refused).      When False, cleans, #1116: a symbol removed from a re-extracted file is a legitimate shrink —     e, The guard's real job is intact: a node lost from a file we did NOT re-extract, new > existing is always fine., When refusing, the temp graph file gets cleaned up so it can't leak across runs., Mirror of the above: if the caller declared deletions, the tmp file is NOT unlin, Build a minimal graph-data dict with *n* placeholder nodes. (+14 more)

### Community 133 - "_corpus"
Cohesion: 0.13
...
### Community 138 - "test_gemini_hook.py"
Cohesion: 0.12
Nodes (19): _claude_pretooluse_hooks(), _gemini_hook(), _install_claude_hook(), _install_codebuddy_hook(), _install_gemini_hook(), Return the absolute path to the graphify executable.      Falls back to bare ', Add graphify PreToolUse hook to .claude/settings.json., graphify's Claude/Codebuddy PreToolUse hooks, resolved at install time.      T (+11 more)

### Community 139 - "test_llm_parser.py"
Cohesion: 0.11
...
### Community 141 - "affected.py"
Cohesion: 0.17
Nodes (18): affected_nodes(), AffectedHit, _bare_name(), format_affected(), _format_location(), load_graph(), _node_label(), _normalize_label() (+10 more)

### Community 142 - "test_affected_cli.py"
Cohesion: 0.15
...
### Community 144 - "dedup.py"
Cohesion: 0.12
Nodes (19): _collision_rank(), _defines_id(), _id_prefixes(), _is_code(), _make_minhash(), Entity deduplication pipeline for graphify knowledge graphs.  Pipeline: exact, True for AST-extracted code symbols.      Code-node identity is the node ID (w, The ID prefixes a node extracted from ``source_file`` may legitimately mint. (+11 more)

### Community 145 - "to_canvas"
Cohesion: 0.11
Nodes (20): _dedup_node_filenames(), Map each node_id to a unique note filename, appending a numeric suffix on     c, Export graph as an Obsidian Canvas file - communities as groups, nodes as cards., to_canvas(), _case_collision_graph(), _punct_graph(), #1452: a community's node cards are laid out in the same ceil(sqrt(n))-column, A 2-node graph where one node's label is all-punctuation (e.g. a `@/*`     tsco (+12 more)

### Community 146 - "extract_julia"
Cohesion: 0.10
Nodes (19): extract_julia(), Path, julia — moved verbatim from graphify/extract.py., Extract modules, structs, functions, imports, and calls from a .jl file., Qualified (`using Base.Threads`) and relative (`using ..Mod`) imports     must, test_julia_abstract_concrete_hierarchy_inherits(), test_julia_call_edges_have_call_context(), test_julia_finds_abstract_type() (+11 more)

### Community 147 - "save_query_result"
Cohesion: 0.16
...
### Community 148 - "run_language_resolvers"
Cohesion: 0.17
...
### Community 149 - "validate_extraction"
Cohesion: 0.18
Nodes (18): assert_valid(), Validate an extraction JSON dict against the graphify schema.     Returns a lis, Raise ValueError with all errors if extraction is invalid., validate_extraction(), test_assert_valid_passes_silently(), test_assert_valid_raises_on_errors(), test_dangling_edge_source(), test_dangling_edge_target() (+10 more)

### Community 150 - "test_cpp_objc_cross_file_calls.py"
Cohesion: 0.28
...
### Community 151 - "test_install_upgrade.py"
Cohesion: 0.15
...
### Community 152 - "main"
Cohesion: 0.12
Nodes (22): always_on_roundtrip(), bless(), check(), _expected_path(), main(), _parse_args(), Path, Assert each always_on/*.md reproduces its former constant byte for byte. (+14 more)

### Community 153 - "ToolkitViewModel"
Cohesion: 0.13
Nodes (15): Email, RefreshCommand, string, ToolkitViewModel, Email, RefreshCommand, SaveCommand, UserName (+7 more)

### Community 154 - "callflow_html.py"
Cohesion: 0.15
...
### Community 155 - "extract_dm"
Cohesion: 0.12
Nodes (19): extract_dm(), Extract types, procs, includes, and calls from a .dm/.dme file., _calls(), Regression test for the call-walker `simple_identifier` /     `identifier` rena, test_cuda_host_call_edges(), test_dm_ambiguous_member_call_left_unresolved(), test_dm_call_edges_have_call_context(), test_dm_emits_include_edge() (+11 more)

### Community 156 - "extract_terraform"
Cohesion: 0.22
...
### Community 157 - "test_ollama.py"
Cohesion: 0.12
Nodes (17): detect_backend(), Return the name of whichever backend has an API key set, or None.      Priorit, Tests for the Ollama backend additions in graphify/llm.py., Link-local / cloud-metadata Ollama targets fail closed (F3)., Loopback is silent; a general LAN host warns but is allowed (F3)., A hostname that RESOLVES to a link-local IP is blocked, not just literals (F3)., warn=False suppresses the LAN warning but never the metadata hard-block (F3)., extract_files_direct with backend=ollama and no OLLAMA_API_KEY should use sentin (+9 more)

### Community 158 - "sample.kt"
Cohesion: 0.13
Nodes (15): ChatType, GROUP, NORMAL, SYSTEM, createClient(), BaseProcessor, Config, DataProcessor (+7 more)

### Community 159 - "backup_if_protected"
Cohesion: 0.11
...
### Community 160 - "test_build_merge_hyperedges_and_prune.py"
Cohesion: 0.18
...
### Community 161 - "test_confidence.py"
Cohesion: 0.14
...
### Community 162 - "test_evidence_binding.py"
Cohesion: 0.20
Nodes (14): _by_label(), Tests for semantic evidence-binding in graphify.llm.  A code node the model re, Drive extract_files_direct with a faked backend returning ``nodes``., _run(), test_diagnostics_reports_unverified_node_count(), test_document_and_sourceless_nodes_are_never_flagged(), test_downgrade_emits_stderr_summary(), test_evidence_binding_handles_file_slice() (+6 more)

### Community 163 - "_make_random_scoring_graph"
Cohesion: 0.13
Nodes (18): _make_random_scoring_graph(), Test-only oracle for the legacy per-term `_pick_seeds(terms=...)` loop.      R, Reproducible broad-match DiGraph: short constructed labels + edge noise., `_score_query(..., collect_per_term_seeds=False).ranked` is the byte-for-     b, Per-token winner the single-pass scorer records matches the legacy     `_score_, The seeds produced by `_pick_seeds(qs.ranked, G=G, best_seed_by_term=     qs.be, Across many deterministic random graphs and many random multi-term     queries,, When the trigram prefilter falls back to a full-graph scan, the     single-pass (+10 more)

### Community 164 - "test_ts_decorators.py"
Cohesion: 0.30
...
### Community 165 - "Platform"
Cohesion: 0.16
Nodes (17): load_platforms(), _normalise(), Platform, One render unit parsed from platforms.toml., The prose file name the lean-core hooks pointer names for this host., Parse platforms.toml into Platform records, keyed by platform name., Read a fragment file under fragments/, normalised to LF newlines., Force LF newlines and exactly one trailing newline. (+9 more)

### Community 166 - "utils.py"
Cohesion: 0.12
...
### Community 169 - "html.py"
Cohesion: 0.15
Nodes (15): _html_script(), _html_styles(), _hyperedge_script(), html — moved verbatim from graphify/export.py., Return the effective viz node limit, honoring GRAPHIFY_VIZ_NODE_LIMIT env var., _viz_node_limit(), _build_csharp_type_def_index(), Path (+7 more)

### Community 170 - "extract_groovy"
Cohesion: 0.12
...
### Community 171 - "_rewire_unique_stub_nodes"
Cohesion: 0.12
Nodes (17): _is_top_level_function_definition(), _lang_family(), _lang_is_case_insensitive(), _node_label_key(), True when the file's language resolves identifiers case-insensitively (#1581)., Interop family of the file's language, or None when unknown/not code., A free/top-level function def (label ``name()``), not a method or type.      M, Map unresolved no-source stubs to a unique real definition with the same label. (+9 more)

### Community 172 - "_extract_pascal_regex"
Cohesion: 0.16
...
### Community 173 - "test_symbol_resolution.py"
Cohesion: 0.17
...
### Community 174 - "typescript_advanced.ts"
Cohesion: 0.12
Nodes (10): DEFAULT_ROLES, IUserRepository, USER_CONFIG, USER_REPOSITORY, UserId, UserModule, UserService, UserStatus (+2 more)

### Community 175 - "test_incremental.py"
Cohesion: 0.20
...
### Community 176 - "_extract_sql_or_skip"
Cohesion: 0.12
Nodes (17): _extract_sql_or_skip(), ALTER TABLE ... FOREIGN KEY ... REFERENCES produces a references edge., Schema-qualified table names (Schema.Table) are preserved., ALTER TABLE with schema-qualified names produces correct edges., PL/pgSQL bodies make tree-sitter-sql emit ERROR nodes; the functions     must s, A cleanly-parsed LANGUAGE sql function in the same file is emitted once., test_sql_alter_table_fk_edge(), test_sql_emits_foreign_key_edge() (+9 more)

### Community 177 - "test_provider_registry.py"
Cohesion: 0.12
...
### Community 178 - "test_semantic_similarity.py"
Cohesion: 0.18
...
### Community 182 - "sample.ps1"
Cohesion: 0.17
Nodes (9): double, Get-Data(), Invoke-Main(), Process-Items(), Circle, DataProcessor, Shape, string (+1 more)

### Community 183 - "_semantic_id_remap"
Cohesion: 0.16
Nodes (14): Re-derive non-AST node ids from ``source_file`` using the canonical     full-pa, _semantic_id_remap(), Re-key contract: a relative source_file is migrated; an absolute one is left, test_semantic_rekey_relative_vs_absolute_source_file(), A node whose source_file equals the scan root must not crash build (#1618).  `, A file whose parent dir name equals its stem (.claude/CLAUDE.md ->     canonica, The bare file node id follows the same fixed-point rule., The idempotency guard must not block a real one-time legacy migration:     a pr (+6 more)

### Community 184 - "_query_graph_text"
Cohesion: 0.12
...
### Community 185 - "DataProcessor"
Cohesion: 0.16
Nodes (9): ErrorCode, GAME_DONE, OK, BaseProcessor, DataProcessor, Processor, Result, HttpClient (+1 more)

### Community 186 - "test_incomplete_build_guard.py"
Cohesion: 0.24
Nodes (15): _arm_extract(), _arm_no_cluster(), _make_docs_corpus(), Tests for the incomplete-build shrink-guard on `graphify extract`.  A full bui, A present-but-unparseable existing graph.json (corrupt or mid-write) could, Patch export.to_json to record the ``force`` it was called with and return, _seed_existing_graph(), _seed_to_json_recorder() (+7 more)

### Community 187 - "test_java_member_calls.py"
Cohesion: 0.40
...
### Community 188 - "_install_capturing_openai"
Cohesion: 0.12
...
### Community 189 - "test_office_limits.py"
Cohesion: 0.15
...
### Community 194 - "_llm_tiebreak"
Cohesion: 0.17
Nodes (11): _crossfile_fileanchored_blocked(), _llm_tiebreak(), _numeric_tokens_differ(), _pick_winner(), Block label-based merging of file-anchored non-code nodes across files (#1284)., Pick the canonical survivor: prefer no chunk suffix, then shorter ID., Batch-resolve ambiguous pairs (score in [low, high)) via LLM., True when two labels carry different embedded numbers (#1284).      Long label (+3 more)

### Community 195 - "extract_astro"
Cohesion: 0.27
...
### Community 196 - "make_pr"
Cohesion: 0.29
Nodes (6): _classify(), make_pr(), datetime, Tests for graphify/prs.py., Build a minimal PRInfo with sensible defaults., TestClassify

### Community 197 - "resolve_python_import_guided_calls"
Cohesion: 0.13
...
### Community 201 - "test_java_type_resolution.py"
Cohesion: 0.39
...
### Community 202 - "_clear_backend_env"
Cohesion: 0.13
...
### Community 203 - "test_search_hook.py"
Cohesion: 0.22
...
### Community 204 - "_claude_artifacts"
Cohesion: 0.13
...
### Community 205 - "cn"
Cohesion: 0.25
Nodes (8): CardSpotlight(), Direction, HoverBorderGradient(), Meteors(), Spotlight(), SpotlightProps, TextGenerateEffect(), cn()

### Community 206 - "clear_cache"
Cohesion: 0.21
...
### Community 208 - "test_falkordb_integration.py"
Cohesion: 0.16
...
### Community 209 - "parse_python_import_aliases"
Cohesion: 0.15
...
### Community 213 - "test_extract_cache_location.py"
Cohesion: 0.24
Nodes (13): _make_corpus(), Path, #1774 — extract() must never write its AST cache into the analyzed source tree., The location/anchor split must keep content-hash keys anchored on the     corpu, The stat-index location is chosen once per process via a module global     (#17, Fresh-process regression for the stat-index leak specifically: even for a     W, A second extract() of the same corpus must hit the CWD cache the first     wrot, _reset_stat_index() (+5 more)

### Community 214 - "test_pipeline.py"
Cohesion: 0.23
...
### Community 215 - "test_swift_cross_file_calls.py"
Cohesion: 0.32
...
### Community 216 - "test_ts_namespace.py"
Cohesion: 0.30
...
### Community 217 - "Geometry"
Cohesion: 0.21
Nodes (11): Base, Base.Threads, Float64, area(), describe(), Circle, Geometry, Point (+3 more)

### Community 218 - "sample.razor"
Cohesion: 0.15
...
### Community 227 - "extract_pascal"
Cohesion: 0.24
Nodes (11): extract_pascal(), Extract units, classes, procedures, uses-imports, and calls from Pascal/Delphi f, _labels(), test_pascal_all_edges_extracted(), test_pascal_finds_classes(), test_pascal_finds_interface(), test_pascal_finds_methods(), test_pascal_finds_unit() (+3 more)

### Community 228 - "extract_verilog"
Cohesion: 0.17
Nodes (12): extract_verilog(), Path, Extract modules, functions, tasks, package imports, instantiations, and     Sys, Class properties with leading qualifiers (rand/local/protected/etc.) must     s, test_systemverilog_does_not_emit_type_parameter_refs(), test_systemverilog_field_parameter_return_and_generic_contexts(), test_systemverilog_missing_file_returns_empty(), test_systemverilog_no_dangling_edges() (+4 more)

### Community 229 - "gemini_install"
Cohesion: 0.18
Nodes (12): gemini_install(), gemini_uninstall(), Copy skill file, write GEMINI.md section, and install BeforeTool hook., Remove the graphify section from GEMINI.md, uninstall hook, and remove skill fil, _uninstall_gemini_hook(), test_gemini_install_idempotent(), test_gemini_install_merges_existing_gemini_md(), test_gemini_install_writes_gemini_md() (+4 more)

### Community 230 - "attach_graph_impact"
Cohesion: 0.23
...
### Community 232 - "test_explain_cli.py"
Cohesion: 0.36
...
### Community 233 - "test_extraction_spec_ids.py"
Cohesion: 0.27
...
### Community 234 - "test_hooks_dir_duplicate_config_keys_honor_custom_hookspath"
Cohesion: 0.18
Nodes (12): _append_duplicate_config_entries(), Path, A Windows-style core.hooksPath must raise (loud failure), not silently     crea, A legitimate POSIX core.hooksPath (Husky-style) must still install., Append git-legal duplicate keys/sections (as VS Code writes them)., git legally allows duplicate keys and repeated sections in .git/config;     a s, With duplicate keys present, a custom core.hooksPath must still be     honored, _set_hookspath() (+4 more)

### Community 235 - "test_indirect_dispatch_getattr.py"
Cohesion: 0.38
...
### Community 236 - "test_path_cli.py"
Cohesion: 0.27
...
### Community 237 - "test_ts_generators.py"
Cohesion: 0.36
...
### Community 238 - "test_ts_import_require.py"
Cohesion: 0.39
...
### Community 239 - "test_typescript_module_extensions.py"
Cohesion: 0.26
Nodes (7): _extract(), _labels(), Path, TypeScript module extensions (`.mts` / `.cts`) are treated as code.  `.mts` (E, test_cts_uses_the_typescript_grammar(), test_mts_uses_the_typescript_grammar(), test_uppercase_typescript_extensions_use_typescript_grammar()

### Community 240 - "validate_document"
Cohesion: 0.18
...
### Community 242 - "extract_lazarus_package"
Cohesion: 0.29
Nodes (7): extract_lazarus_package(), Extract package metadata from Lazarus .lpk package files (XML format).      .l, test_lpk_contains_listed_units(), test_lpk_finds_package_name(), test_lpk_finds_required_packages(), test_lpk_no_dangling_edges(), test_lpk_no_error()

### Community 243 - "_parse_llm_json"
Cohesion: 0.25
Nodes (10): _parse_llm_json(), Force ``nodes``/``edges``/``hyperedges`` to lists of dicts, in place.      A m, Strip optional markdown fences and parse JSON. Returns empty fragment on failure, _sanitize_fragment(), #1631 — a malformed LLM chunk (a stray non-dict entry in edges/nodes) must not, test_merge_after_sanitize_does_not_raise_on_source_file_access(), test_parse_llm_json_fenced_response_is_sanitized(), test_parse_llm_json_sanitizes_stray_list_in_edges() (+2 more)

### Community 244 - "compute_pr_impact"
Cohesion: 0.35
...
### Community 245 - "_detect_default_branch"
Cohesion: 0.27
...
### Community 246 - "parse_memory_doc"
Cohesion: 0.18
...
### Community 247 - "validate_graph_path"
Cohesion: 0.18
...
### Community 248 - "_rebuild_lock"
Cohesion: 0.18
Nodes (11): Per-repo advisory lock around a rebuild.      Yields True if acquired, False i, _rebuild_lock(), GH-858: lock file must be unlinked once the rebuild completes so     downstream, GH-858: each acquisition truncates and rewrites the PID line rather     than ap, #1059: when the rebuild lock is held, an incremental hook must queue     its ch, GH-858: a non-blocking caller that fails to acquire the lock must not     trunc, test_rebuild_code_queues_on_lock_contention(), test_rebuild_lock_does_not_accumulate_pids_across_runs() (+3 more)

### Community 249 - "barrel_reexport.ts"
Cohesion: 0.25
Nodes (4): readCookie(), writeCookie(), basePathRewrite(), getFullUrl()

### Community 250 - "TMainForm"
Cohesion: 0.18
Nodes (5): TButton, TPanel, TMainForm, TMemo, TStatusBar

### Community 251 - "test_cjs_module_extension.py"
Cohesion: 0.22
...
### Community 252 - "test_indirect_dispatch_assign_return.py"
Cohesion: 0.42
...
### Community 253 - "_fake_openai_response"
Cohesion: 0.24
...
### Community 254 - "test_merge_graphs_cli.py"
Cohesion: 0.29
...
### Community 255 - "load_memory_docs"
Cohesion: 0.20
...
### Community 256 - "tree_html.py"
Cohesion: 0.38
Nodes (9): build_tree(), _common_root(), emit_html(), _make_truncation_leaf(), Any, Path, tree_html — emit a D3 v7 collapsible-tree HTML view of a graph.  A self-contai, Build a ``{name, total_count, children}`` hierarchy.      Each leaf is either (+1 more)

### Community 257 - "_queue_pending"
Cohesion: 0.22
...
### Community 260 - "test_pascal_call_scoping.py"
Cohesion: 0.49
...
### Community 261 - "test_pascal_resolution.py"
Cohesion: 0.31
...
### Community 262 - "test_phantom_cross_package_call.py"
Cohesion: 0.56
...
### Community 263 - "test_php_type_resolution.py"
Cohesion: 0.56
Nodes (9): _class_defs(), _node_by_id(), Path, test_php_ambiguous_base_disambiguated_by_use(), test_php_external_namespaced_base_does_not_collapse_onto_internal_class(), test_php_fully_qualified_base_resolves(), test_php_plain_no_namespace_inheritance_preserved(), test_php_use_alias_resolves() (+1 more)

### Community 264 - "test_wheel_packaging.py"
Cohesion: 0.29
...
### Community 267 - "sanitize_metadata"
Cohesion: 0.22
...
### Community 268 - "verilog.py"
Cohesion: 0.33
Nodes (7): _augment_systemverilog_semantics(), Verilog extractor. Moved verbatim from graphify/extract.py., First `simple_identifier` under node in pre-order, or None.      tree-sitter-v, _sv_collect_type_refs(), _sv_first_identifier(), _sv_split_type_list(), _sv_strip_comments()

### Community 269 - "_replace_or_append_section"
Cohesion: 0.33
...
### Community 277 - "test_callflow_html.py"
Cohesion: 0.31
...
### Community 278 - "test_cross_language_call_resolution.py"
Cohesion: 0.58
...
### Community 279 - "test_obsidian_dangling_member.py"
Cohesion: 0.28
...
### Community 281 - "prompt_fingerprint"
Cohesion: 0.25
Nodes (8): prompt_fingerprint(), Return a short stable fingerprint of an extraction prompt.      ``prompt`` is, The fingerprint is stable for identical prompts and differs when the     prompt, A CRLF checkout of the same spec must not look like a prompt change —     other, Fingerprinted entries live under cache/semantic/p{fp}/, never flat., test_prompt_fingerprint_ignores_line_endings(), test_prompt_fingerprint_stable_and_prompt_sensitive(), test_semantic_cache_prompt_namespaced_layout()

### Community 282 - "_is_variant_pair"
Cohesion: 0.25
Nodes (8): _is_variant_pair(), True if a and b are sibling model/SKU variants (same stem, different suffix)., Block fuzzy merge for short labels unless it's a same-length single-char substit, _short_label_blocked(), Genuine same-length single-char typos should still merge (#878 non-regression)., _is_variant_pair correctly identifies chip-model variant pairs (#878)., test_dedup_still_merges_real_typos(), test_variant_pair_helper()

### Community 283 - "validate_url"
Cohesion: 0.22
...
### Community 286 - "gen_demo_path.py"
Cohesion: 0.29
...
### Community 287 - "sample.zig"
Cohesion: 0.32
Nodes (6): add(), Color, multiply(), main(), Point, Shape

### Community 289 - "test_case_sensitive_resolution.py"
Cohesion: 0.54
...
### Community 290 - "test_corrupt_graph_json.py"
Cohesion: 0.36
Nodes (7): _corrupt(), Corrupt graph.json produces an actionable error, not a raw traceback (#1536/#153, Happy path unchanged: a well-formed graph.json loads without raising., test_affected_load_graph_corrupt_raises_runtimeerror(), test_build_merge_corrupt_graph_raises_runtimeerror(), test_diagnostics_read_corrupt_raises_runtimeerror(), test_valid_graph_still_loads()

### Community 291 - "test_office_incremental.py"
Cohesion: 0.50
...
### Community 292 - "test_phantom_external_import.py"
Cohesion: 0.39
...
### Community 293 - "test_skill_version_warning.py"
Cohesion: 0.36
Nodes (6): _make_skill(), Path, Direction-aware skill-version mismatch warning (#1568).  `_check_skill_version, test_matching_version_is_silent(), test_skill_newer_than_package_recommends_upgrade_not_install(), test_skill_older_than_package_recommends_install()

### Community 294 - "test_swift_import_resolution.py"
Cohesion: 0.61
...
### Community 295 - "test_ts_receiver_member_calls.py"
Cohesion: 0.43
...
### Community 296 - "VoiceManager"
Cohesion: 0.29
Nodes (3): Receives an async generator yielding PCM audio chunks (16kHz) from the frontend,, Takes an async generator yielding text chunks (from Groq LLM),         pipes the, VoiceManager

### Community 297 - "page.tsx"
Cohesion: 0.29
Nodes (3): AnalystFeedback, Message, SUPPORTED_LANGUAGES

### Community 298 - "_path_match"
Cohesion: 0.43
Nodes (3): _path_match(), True if graph_src and pr_file refer to the same file (path-boundary safe)., TestPathMatch

### Community 299 - "lessons_fresh"
Cohesion: 0.29
...
### Community 301 - "_sanitize_metadata_string"
Cohesion: 0.14
Nodes (14): Return a control-character-free, HTML-escaped, bounded string., Sanitize a metadata value while preserving simple JSON-compatible types., _sanitize_metadata_string(), _sanitize_metadata_value(), test_sanitize_metadata_string_caps_length(), test_sanitize_metadata_string_coerces_non_string(), test_sanitize_metadata_string_escapes_html(), test_sanitize_metadata_string_escapes_quotes() (+6 more)

### Community 302 - "extract_delphi_form"
Cohesion: 0.18
Nodes (10): extract_delphi_form(), Pascal_forms extractor. Moved verbatim from graphify/extract.py., Extract component hierarchy from Delphi .dfm form files.      .dfm files come, test_dfm_binary_returns_empty_not_crash(), test_dfm_event_edges_have_event_context(), test_dfm_finds_component_classes(), test_dfm_finds_event_handlers(), test_dfm_finds_root_form_class() (+2 more)

### Community 303 - "Foo"
Cohesion: 0.33
Nodes (3): Foo, bar, value

### Community 304 - "sample_php_listen.php"
Cohesion: 0.43
Nodes (6): EventServiceProvider, NotifyAdmins, OrderPlaced, SendWelcomeEmail, ShipOrder, UserRegistered

### Community 305 - "test_extract_code_only_cli.py"
Cohesion: 0.52
...
### Community 306 - "test_ollama_retry_cap.py"
Cohesion: 0.48
...
### Community 307 - "test_python_import_resolution.py"
Cohesion: 0.52
...
### Community 308 - "normalize_sections"
Cohesion: 0.33
...
### Community 310 - "_ts_emit_decorator_edges"
Cohesion: 0.33
...
### Community 318 - "test_builtin_global_type_refs.py"
Cohesion: 0.53
...
### Community 319 - "test_cli_broken_pipe.py"
Cohesion: 0.33
Nodes (5): CLI must not crash when a downstream reader closes the pipe early (#1807).  Tr, `graphify --help | head -n1` must leave graphify exiting 0, not 255., A short, fully-buffered output (piped stdout is block-buffered) only flushes, test_help_survives_reader_closing_pipe_early(), test_small_buffered_output_survives_reader_that_reads_nothing()

### Community 320 - "test_convert_office_file_does_not_rewrite_existing_sidecar"
Cohesion: 0.20
...
### Community 321 - "_launcher_payload"
Cohesion: 0.33
...
### Community 323 - "_seed_semantic_doc_graph"
Cohesion: 0.33
Nodes (6): Build a code-only graph, then add guide.md represented ONLY semantically., #1915: a full _rebuild_code must not AST-quick-scan a doc whose semantic     (L, #1915: an incremental rebuild whose change set includes a semantic-backed     d, _seed_semantic_doc_graph(), test_rebuild_code_incremental_preserves_semantic_doc_nodes_and_edges(), test_rebuild_code_semantic_doc_not_double_represented_on_full_rebuild()

### Community 324 - "_cpp_preprocess"
Cohesion: 0.40
Nodes (4): _cpp_preprocess(), Path, Fortran extractor. Moved verbatim from graphify/extract.py., Run cpp -w -P on a capital-F Fortran file and return preprocessed bytes.

### Community 325 - "monolith_roundtrip"
Cohesion: 0.20
Nodes (10): _always_on_constants(), _git_show(), _is_sanctioned_monolith_diff(), _is_trigger_line(), monolith_roundtrip(), Read a blob from git, normalised to LF., Whether a line is the non-spec ``trigger:`` frontmatter field (#1180).      Th, Whether a single added/removed monolith line is an allowed change. (+2 more)

### Community 326 - "Domain"
Cohesion: 0.70
Nodes (3): Domain, WebApi, Tests

### Community 327 - "SamplePackage"
Cohesion: 0.40
Nodes (4): FCL, SamplePackage, LCL, sampleutils

### Community 328 - "layout.tsx"
Cohesion: 0.40
Nodes (3): metadata, playfair, quicksand

### Community 329 - "extract_blade"
Cohesion: 0.40
...
### Community 330 - "UserControl"
Cohesion: 0.40
Nodes (3): SettingsViewModel, SettingsView, UserControl

### Community 331 - "_bash_make_id"
Cohesion: 0.40
...
### Community 332 - "TOtherGadget"
Cohesion: 0.40
Nodes (3): OtherGadget, TObject, TOtherGadget

### Community 333 - "MyApp.Accounts.User"
Cohesion: 0.50
Nodes (3): MyApp.Accounts.User, create(), validate()

### Community 338 - "test_backend_extras.py"
Cohesion: 0.60
...
### Community 340 - "test_rebuild_code_prunes_final_deleted_file"
Cohesion: 0.40
...
### Community 341 - "deduplicate_by_label"
Cohesion: 0.50
Nodes (4): deduplicate_by_label(), _norm_label(), Canonical dedup key — Unicode-aware, preserves CJK/word characters., Merge nodes that share a normalised label, rewriting edge references.      Pre
...
### Community 344 - "_detached_launch"
Cohesion: 0.50
...
### Community 345 - "_uninstall_claude_hook"
Cohesion: 0.50
Nodes (4): Remove the graphify PreToolUse hook from .claude/settings.json and its     loca, Drop graphify PreToolUse hooks from a single Claude settings file, if present., _strip_graphify_hook(), _uninstall_claude_hook()

### Community 346 - "_write_build_config"
Cohesion: 0.50
Nodes (4): Persist build options (currently ``--exclude`` patterns) under ``out_dir``., _write_build_config(), #1886: `--exclude` recorded at extract time must survive into update/watch/, test_rebuild_honors_persisted_excludes()

### Community 352 - "App"
Cohesion: 0.83
Nodes (3): App(), fmtCount(), fmtDate()

### Community 357 - "test_label_retry.py"
Cohesion: 0.50
...
### Community 358 - "_make_cli_envelope"
Cohesion: 0.50
...
### Community 359 - "test_pascal_no_duplicate_method_edges_tree_sitter"
Cohesion: 0.50
Nodes (4): _dup_edges(), A class method appears in both the interface declaration and the     implementa, test_pascal_no_duplicate_method_edges_regex(), test_pascal_no_duplicate_method_edges_tree_sitter()

### Community 361 - "schema_singleton"
Cohesion: 0.50
...
### Community 362 - "build_from_json"
Cohesion: 0.67
Nodes (3): build(), build_from_json(), Merge multiple extraction results into one graph.

### Community 375 - "test_worktree_guard_runs_on_primary_skips_linked"
Cohesion: 0.67
Nodes (3): End-to-end against a real `git worktree`: the guard falls through on the     pr, test_worktree_guard_runs_on_primary_skips_linked(), _worktree_guard_snippet()

### Community 376 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\alembic\\env.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\alembic\\env.py, hash, mtime

### Community 377 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\alembic\\versions\\0002_add_preview_columns.py"
Cohesion: 0.67
...
### Community 378 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\alembic\\versions\\0003_make_siege_date_nullable.py"
Cohesion: 0.67
...
### Community 379 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\alembic\\versions\\0004_add_post_priority_config.py"
Cohesion: 0.67
...
### Community 380 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\alembic\\versions\\0005_add_description_to_post_priority_config.py"
Cohesion: 0.67
...
### Community 381 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\alembic\\versions\\0006_power_level_and_drop_sort_value.py"
Cohesion: 0.67
...
### Community 382 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\alembic\\versions\\0007_fix_group_number_max.py"
Cohesion: 0.67
...
### Community 383 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\alembic\\versions\\0008_add_matched_condition_id_to_position.py"
Cohesion: 0.67
...
### Community 384 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\alembic\\versions\\0009_add_discord_id_to_member.py"
Cohesion: 0.67
...
### Community 385 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\alembic\\versions\\0010_add_last_seen_changelog_at_to_member.py"
Cohesion: 0.67
...
### Community 386 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\alembic\\versions\\0011_add_post_suggest_preview.py"
Cohesion: 0.67
...
### Community 387 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\attack_day.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\attack_day.py, hash, mtime

### Community 388 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\auth.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\auth.py, hash, mtime

### Community 389 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\autofill.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\autofill.py, hash, mtime

### Community 390 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\board.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\board.py, hash, mtime

### Community 391 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\buildings.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\buildings.py, hash, mtime

### Community 392 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\changelog.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\changelog.py, hash, mtime

### Community 393 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\comparison.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\comparison.py, hash, mtime

### Community 394 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\discord_sync.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\discord_sync.py, hash, mtime

### Community 395 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\health.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\health.py, hash, mtime

### Community 396 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\images.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\images.py, hash, mtime

### Community 397 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\lifecycle.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\lifecycle.py, hash, mtime

### Community 398 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\members.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\members.py, hash, mtime

### Community 399 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\notifications.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\notifications.py, hash, mtime

### Community 400 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\post_priority_config.py"
Cohesion: 0.67
...
### Community 401 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\post_suggestions.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\post_suggestions.py, hash, mtime

### Community 402 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\posts.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\posts.py, hash, mtime

### Community 403 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\reference.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\reference.py, hash, mtime

### Community 404 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\siege_members.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\siege_members.py, hash, mtime

### Community 405 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\sieges.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\sieges.py, hash, mtime

### Community 406 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\validation.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\validation.py, hash, mtime

### Community 407 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\version.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\api\\version.py, hash, mtime

### Community 408 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\config.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\config.py, hash, mtime

### Community 409 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\db\\base.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\db\\base.py, hash, mtime

### Community 410 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\db\\__init__.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\db\\__init__.py, hash, mtime

### Community 411 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\db\\seeds.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\db\\seeds.py, hash, mtime

### Community 412 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\db\\session.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\db\\session.py, hash, mtime

### Community 413 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\dependencies\\auth.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\dependencies\\auth.py, hash, mtime

### Community 414 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\dependencies\\__init__.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\dependencies\\__init__.py, hash, mtime

### Community 415 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\__init__.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\__init__.py, hash, mtime

### Community 416 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\main.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\main.py, hash, mtime

### Community 417 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\middleware.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\middleware.py, hash, mtime

### Community 418 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\building_group.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\building_group.py, hash, mtime

### Community 419 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\building.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\building.py, hash, mtime

### Community 420 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\building_type_config.py"
Cohesion: 0.67
...
### Community 421 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\enums.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\enums.py, hash, mtime

### Community 422 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\__init__.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\__init__.py, hash, mtime

### Community 423 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\member_post_preference.py"
Cohesion: 0.67
...
### Community 424 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\member.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\member.py, hash, mtime

### Community 425 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\notification_batch.py"
Cohesion: 0.67
...
### Community 426 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\notification_batch_result.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\notification_batch_result.py, hash, mtime

### Community 427 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\position.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\position.py, hash, mtime

### Community 428 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\post_active_condition.py"
Cohesion: 0.67
...
### Community 429 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\post_condition.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\post_condition.py, hash, mtime

### Community 430 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\post_priority_config.py"
Cohesion: 0.67
...
### Community 431 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\post.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\post.py, hash, mtime

### Community 432 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\siege_member.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\siege_member.py, hash, mtime

### Community 433 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\siege.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\models\\siege.py, hash, mtime

### Community 434 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\rate_limit.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\rate_limit.py, hash, mtime

### Community 435 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\attack_day.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\attack_day.py, hash, mtime

### Community 436 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\autofill.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\autofill.py, hash, mtime

### Community 437 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\board.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\board.py, hash, mtime

### Community 438 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\building.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\building.py, hash, mtime

### Community 439 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\changelog.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\changelog.py, hash, mtime

### Community 440 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\common.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\common.py, hash, mtime

### Community 441 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\comparison.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\comparison.py, hash, mtime

### Community 442 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\__init__.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\__init__.py, hash, mtime

### Community 443 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\member.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\member.py, hash, mtime

### Community 444 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\post_condition.py"
Cohesion: 0.67
...
### Community 445 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\post.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\post.py, hash, mtime

### Community 446 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\post_suggestions.py"
Cohesion: 0.67
...
### Community 447 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\siege_member.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\siege_member.py, hash, mtime

### Community 448 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\siege.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\siege.py, hash, mtime

### Community 449 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\validation.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\validation.py, hash, mtime

### Community 450 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\version.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\schemas\\version.py, hash, mtime

### Community 451 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\attack_day.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\attack_day.py, hash, mtime

### Community 452 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\autofill.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\autofill.py, hash, mtime

### Community 453 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\board.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\board.py, hash, mtime

### Community 454 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\bot_client.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\bot_client.py, hash, mtime

### Community 455 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\building_capacity.py"
Cohesion: 0.67
...
### Community 456 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\buildings.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\buildings.py, hash, mtime

### Community 457 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\comparison.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\comparison.py, hash, mtime

### Community 458 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\discord_sync.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\discord_sync.py, hash, mtime

### Community 459 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\image_gen.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\image_gen.py, hash, mtime

### Community 460 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\lifecycle.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\lifecycle.py, hash, mtime

### Community 461 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\members.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\members.py, hash, mtime

### Community 462 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\notification_message.py"
Cohesion: 0.67
...
### Community 463 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\post_suggestions.py"
Cohesion: 0.67
...
### Community 464 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\posts.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\posts.py, hash, mtime

### Community 465 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\reference.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\reference.py, hash, mtime

### Community 466 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\siege_members.py"
Cohesion: 0.67
...
### Community 467 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\sieges.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\sieges.py, hash, mtime

### Community 468 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\validation.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\services\\validation.py, hash, mtime

### Community 469 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\telemetry.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\app\\telemetry.py, hash, mtime

### Community 470 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\scripts\\seed_demo.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\scripts\\seed_demo.py, hash, mtime

### Community 471 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\scripts\\seed.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\scripts\\seed.py, hash, mtime

### Community 472 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\conftest.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\conftest.py, hash, mtime

### Community 473 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\__init__.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\__init__.py, hash, mtime

### Community 474 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_attack_day.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_attack_day.py, hash, mtime

### Community 475 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_auth.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_auth.py, hash, mtime

### Community 476 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_auth_rate_limit.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_auth_rate_limit.py, hash, mtime

### Community 477 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_autofill.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_autofill.py, hash, mtime

### Community 478 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_board.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_board.py, hash, mtime

### Community 479 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_bot_client.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_bot_client.py, hash, mtime

### Community 480 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_buildings.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_buildings.py, hash, mtime

### Community 481 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_changelog.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_changelog.py, hash, mtime

### Community 482 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_comparison.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_comparison.py, hash, mtime

### Community 483 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_config_endpoint.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_config_endpoint.py, hash, mtime

### Community 484 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_config.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_config.py, hash, mtime

### Community 485 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_cors.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_cors.py, hash, mtime

### Community 486 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_discord_sync.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_discord_sync.py, hash, mtime

### Community 487 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_enums.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_enums.py, hash, mtime

### Community 488 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_health.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_health.py, hash, mtime

### Community 489 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_image_gen.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_image_gen.py, hash, mtime

### Community 490 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_lifecycle_integration.py"
Cohesion: 0.67
...
### Community 491 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_lifecycle.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_lifecycle.py, hash, mtime

### Community 492 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_member_changelog_column.py"
Cohesion: 0.67
...
### Community 493 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_members.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_members.py, hash, mtime

### Community 494 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_notification_message.py"
Cohesion: 0.67
...
### Community 495 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_notifications.py"
Cohesion: 0.67
Nodes (3): I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_notifications.py, hash, mtime

### Community 496 - "I:\\games\\raid\\siege-web\\.worktrees\\experiment-graphify-dry-run-doc\\backend\\tests\\test_post_suggestions_integration.py"
Cohesion: 0.67
...
- **Why does `dispatch_command()` connect `dispatch_command` to `tree_html.py`, `_search_tokens`, `llm.py`, `affected.py`, `check_update`, `build.py`, `test_export.py`, `test_cluster.py`, `test_global_graph.py`, `test_serve.py`, `test_indirect_dispatch.py`, `test_labeling.py`, `paths.py`, `_rebuild_code`, `_query_graph_text`, `_make_graph`, `test_benchmark.py`, `edge_data`, `export.py`, `analyze.py`, `cluster.py`, `test_multigraph_diagnostics.py`, `_find_node`, `test_merge_chunks_validation.py`, `check_semantic_cache`, `introspect_cargo`, `introspect_postgres`, `_detect_default_branch`, `__main__.py`, `generate`, `diagnose_extraction`, `prs.py`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `extract()` connect `extract` to `_get_extractor`, `test_extract.py`, `test_pascal_resolution.py`, `test_phantom_cross_package_call.py`, `test_php_type_resolution.py`, `test_dotnet.py`, `test_languages.py`, `extract.py`, `test_js_import_resolution.py`, `resolution.py`, `test_multilang.py`, `run_language_resolvers`, `test_cpp_objc_cross_file_calls.py`, `test_cross_language_call_resolution.py`, `test_ruby_resolution.py`, `test_case_sensitive_resolution.py`, `_edge_labels`, `test_phantom_external_import.py`, `build.py`, `test_swift_import_resolution.py`, `test_ts_decorators.py`, `html.py`, `test_ts_receiver_member_calls.py`, `_rewire_unique_stub_nodes`, `test_indirect_dispatch.py`, `test_python_import_resolution.py`, `paths.py`, `_rebuild_code`, `save_semantic_cache`, `_file_stem`, `test_java_member_calls.py`, `test_builtin_global_type_refs.py`, `_collect_js_symbol_resolution_facts`, `test_file_node_id_spec.py`, `test_java_type_resolution.py`, `manifest_ingest.py`, `clear_cache`, `test_csharp_member_calls.py`, `test_pipeline.py`, `test_swift_cross_file_calls.py`, `test_ts_namespace.py`, `extract_vue`, `test_ts_inheritance.py`, `extract_markdown`, `test_ts_generators.py`, `test_ts_import_require.py`, `_make_id`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `_rebuild_code()` connect `_rebuild_code` to `_get_extractor`, `test_detect.py`, `test_security.py`, `_queue_pending`, `_check_shrink`, `watch`, `extract`, `test_watch.py`, `save_manifest`, `build.py`, `test_export.py`, `test_cluster.py`, `_seed_semantic_doc_graph`, `export.py`, `Path`, `write_callflow_html`, `dispatch_command`, `test_rebuild_code_prunes_final_deleted_file`, `analyze.py`, `cluster.py`, `_write_build_config`, `test_rebuild_code_normalizes_preserved_source_paths`, `test_rebuild_code_prunes_renamed_ast_backed_document`, `generate`, `_rebuild_lock`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Are the 216 inferred relationships involving `extract()` (e.g. with `_resolve_cross_file_csharp_imports()` and `_resolve_csharp_type_references()`) actually correct?**
  _`extract()` has 216 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 51 inferred relationships involving `_rebuild_code()` (e.g. with `dispatch_command()` and `god_nodes()`) actually correct?**
  _`_rebuild_code()` has 51 INFERRED edges - model-reasoned connections that need verification._